...
#define USBD_AUDIO_CONTROL_ITF_PROTOCOL         0x00U
#else
...
#if defined(USBD_AUDIO_USE_UAC1_BUILDER)
#define USBD_AUDIO_STREAM_IN_ITF_PROTOCOL       0x00U
#else
...
#if defined(USBD_AUDIO_USE_UAC1_BUILDER)
#define USBD_AUDIO_STREAM_OUT_ITF_PROTOCOL      0x00U
#else
...
#ifndef USBD_AUDIO_EPOUT_DATA_TYPE
#define USBD_AUDIO_EPOUT_DATA_TYPE              USBD_AUDIO_DATA_EP_TYPE
#endif
